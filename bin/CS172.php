...
<head>
	...
	<title>CS 172</title> <!-- CHANGE VALUE HERE-->
...
<body>
	...
	<h1> CS 172 </h1> <!-- _______________ CHANGE VALUE HERE!!!!! -->
	<div id="B">
		<div id="B1">
...
<script> var className = "CS172"</script> <!-- CHANGE VALUE HERE!!!!! -->
